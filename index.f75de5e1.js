...
const option = document.querySelector(".header__top--part1--select--content--option");
...
button1.addEventListener("click", ()=>{
    ...
    } else window.alert("Please fill in all the required fields in the Info form.");
});
button2.addEventListener("click", ()=>{
    ...
    } else window.alert("Please fill in all the required fields in the Payment form.");
});
